...
import com.company.utilities.Constantes;
...
public class AnimaisDAO {
    ...
    private AnimaisDAO(){
        try {
            conn = DriverManager.getConnection(Constantes.kUrlBanco);
    ...
    private String kUpdateAnimal(Animal animal) {
        return "UPDATE "+ kTableName + " SET nome=\"" + animal.nome + "\"," +"lat=" + animal.lat+ ","
                +"lon=" + animal.lon+ ",altura=" + animal.altura + ",peso=" + animal.peso+ ",tipo=\""
                + animal.tipo + "\" WHERE id=" + animal.getId()+";";
    }
    ...
    private String kDeleteAnimal(Animal animal) {
