...
public class AtividadeSubmarino {
        ...
        do {
            ...
            switch (op){
                ...
                case 2:
                    ...
                    break;
                case 3:
                    menuDepartamento(Produto.departamento.informatica);
                    break;
                case 4:
                    menuDepartamento(Produto.departamento.livro);
                    break;
                case 5:
                    menuDepartamento(Produto.departamento.moveis);
                    break;
                case 6:
                    menuCarrinho();
                    break;
    ...
    static public void menuDepartamento(Produto.departamento dep){
        int op;
        do {
            System.out.println("Produtos desse Departamento.");
